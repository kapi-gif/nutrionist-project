...
//         <nav className="bg-green-950 -ml-6 -mr-6  py-3  text-white h-[70px] rounded-md mt-6">
//           <ul className="flex justify-around items-center px-4 h-full ml-8 mr-8">
...
//       <div className="bg-lime-50 mt-24 p-4 mx-[70px]"> 
//   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    
//     {/* First Blog */}
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Weight Loss Tips</h3>
//       <img src={B1} alt="Weight Loss Strategies" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
...
//           changes.
//         </p>
//         <Link to="/blog/weight-loss-strategies" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-14 ">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Weight Loss Tips</h3>
//       <img src={B2} alt="Portion Control" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
...
//         </p>
//         <Link to="/blog/portion-control" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-14">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     {/* First Blog */}
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Healthy Eating</h3>
//       <img src={B3} alt="Plant-Based Diet" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[145px]" />
//       <h3 className="font-bold text-md mb-2">The Benefits of a Plant-Based Diet for Overall Health</h3>
...
//         </p>
//         <Link to="/blog/plant-based-diet" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-16">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Healthy Eating</h3>
//       <img src={B4} alt="Macronutrients Blog" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
//       <h3 className="font-bold text-md mb-2">Understanding Macronutrients: Carbohydrates, Proteins, and Fats</h3>
...
//         </p>
//         <Link to="/blog/macronutrients" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-16">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     {/* First Blog */}
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Fitness And Exercise</h3>
//       <img src={B5} alt="Cardio vs. Strength Training" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
//       <h3 className="font-bold text-md mb-2">Cardio vs. Strength Training: Which is Better for Weight Loss</h3>
...
//         </p>
//         <Link to="/blog/cardio-vs-strength" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-24">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Fitness And Exercise</h3>
//       <img src={B6} alt="Home Workout Routine" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
//       <h3 className="font-bold text-md mb-2">Building a Home Workout Routine: Tips and Best Practices</h3>
...
//           working out at home.
//         </p>
//         <Link to="/blog/home-workout" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-20">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     {/* First Blog */}
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Mindset and Motivation</h3>
//       <img src={B7} alt="Motivation for Fitness" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
...
//         </p>
//         <Link to="/blog/fitness-motivation" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-24">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Mindset and Motivation</h3>
//       <img src={B8} alt="Mindset for Success" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
...
//         </p>
//         <Link to="/blog/growth-mindset" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-24">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     {/* First Blog */}
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Recipes and Meal Planning</h3>
//       <img src={B9} alt="Meal Planning Tips" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
...
//         </p>
//         <Link to="/blog/meal-planning" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-24">Read More</button>
//         </Link>
//       </div>
//     </div>
...
//     <div>
//       <h3 className="text-lg font-semibold mb-2 underline underline-offset-8 decoration-lime-600 p-3">Recipes and Meal Planning</h3>
//       <img src={B10} alt="Healthy Recipes" className="w-[320px] h-40 object-cover rounded-md mb-2 ml-[140px]" />
...
//         </p>
//         <Link to="/blog/healthy-recipes" className="ml-2">
//           <button className="px-6 py-2 bg-lime-300 hover:bg-lime-500 rounded ml-20">Read More</button>
//         </Link>
//       </div>
//     </div>
...
{/* Second Blog */}
<div className="relative max-w-[360px] mx-auto p-4 bg-lime-50 rounded-md shadow-md mt-6">
  <h3 className="text-lg font-semibold mb-2">Weight Loss Tips</h3>
  <div className="relative overflow-hidden">
    <img
      src={B2}
...
{/* Bottom Navigation Bar */}
<nav className=" w-full bg-teal-950 text-white py-3 h-[150px] mt-[80px]">
  {/* Navigation Links Section */}
  <div className="flex justify-between items-center max-w-5xl mx-auto px-4">
    <h1 className="text-left">Nutritionist</h1>
...
<div className="flex flex-col items-center mt-6 p-2 bg-teal-950 rounded ">
  <div className="flex justify-around items-center gap-0 text-sm text-white w-full border-white px-2 py-1 rounded">
    <p className="mx-1">hello@squareup.com</p>
    <p className="mx-1">+91813232309</p>
    <p className="mx-1">Somewhere in the World</p>
    <p className="mx-1">2023 Nutritionist. All rights reserved</p>
  </div>
</div>
</nav>
